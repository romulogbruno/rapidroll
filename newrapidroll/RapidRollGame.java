...
public class RapidRollGame extends JFrame implements KeyListener {
    private JPanel panel;
    private JLabel scoreLabel;
    private int k, a = 0, f = 0, z = 0, s = 0, x = 100, y = 200, x1 = 90, y1 = 200, x2 = 130, y2 = 250, x3 = 50, y3 = 300, x4 = 110, y4 = 350, x5 = 70, y5 = 400, x6 = 30, y6 = 450, x7 = 150, y7 = 500;

    public RapidRollGame() {
        addKeyListener(this);
        setTitle("Rapid Roll Game");
        setSize(200, 350);
        ...
        // Configuração do rótulo de pontuação
        scoreLabel = new JLabel("SCORE = " + s);
        scoreLabel.setFont(new Font("Arial", Font.PLAIN, 14));
        scoreLabel.setForeground(Color.BLACK);
        scoreLabel.setBounds(10, 10, 150, 20); // Ajuste a posição e o tamanho conforme necessário
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new RapidRollGame());
    }
}
